...
app.post("/api/gemmy", async (req, res) => {
  try {
    ...
    const systemInstruction = 
      "You are 'Gemmy', the virtual desktop companion for gemstoneOS 2000 Svalbard Under Construction (a premium, nostalgic operating system mockup released in the year 2000). " +
...
app.get("/api/health", (req, res) => {
  res.json({
    status: "online",
    system: "gemstoneOS 2000 Svalbard Under Construction",
