    ...
    const welcomeMsgs: ChatMessage[] = [
      {
        id: "wel-1",
        role: "assistant",
        text: "Golly! Welcome to gemstoneOS 2000 Svalbard Under Construction! I am Gemmy, your virtual interactive geode assistant. " +
              "Whether you want to paint custom artwork, solve deep minesweeper deposits, or explore the Information Superhighway, I'm here to help you navigate with 32-bit NT power! " +
